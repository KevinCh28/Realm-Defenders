...
document.addEventListener('DOMContentLoaded', () => {
  ...
  startImage.onload = function() {
    ...
    ctx.fillStyle = 'white';
    ctx.font = '20px arial';
    ctx.fillText('Monsters have invaded the peaceful realm', 270, 100);
    ctx.fillText('of Mekraine and have made their way to your', 255, 125);
    ctx.fillText('village. Pick up your weapons and protect your home!', 220, 150);

    ctx.fillText('INSTRUCTIONS', 375, 225);
